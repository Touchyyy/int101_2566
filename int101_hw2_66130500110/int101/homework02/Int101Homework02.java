...
public class Int101Homework02 {
    ...
    static void work01Utilitor() {
        ...
        System.out.println("computeIsbn10(123456789) returns " + computeIsbn10(943539432));
       /*
    ...
    static void work03Account() {
        ...
        System.out.println("Created person1, person2, account1, account2 Successfully!!");
        account1.deposit(300);
        account2.deposit(300);
        System.out.println("Add 300 to all accounts");
